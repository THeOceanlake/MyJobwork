...
-- drop table #mdspde
select a.sFdbh,sSpbh,nJyxx,nJysx,sPslx,srq into #mdspde from  Sys_GoodsConfig_his  a,
#Tmp_FDfw b
where  1=1 and a.sFdbh=b.sFDBH and CONVERT(date,djssj)=CONVERT(date,GETDATE()-1);

select a.sFdbh,a.sSpbh,c.sSpmc,c.sFl,c.sGys,c.nJj,c.nSj,1 sZdbh,d.sPsfs,a.nRjxl_De*c.nJj nrjxse,
