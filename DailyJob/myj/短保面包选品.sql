...
-- Step 4:写入数据
 ...
 -- Step 5： 总指标更新
	...
	select * from  dbo.Xp_BD_Flys_Value_All a 
	left join Tmp_Sp_Flys_Backup b on a.sSpbh=b.sspbh and a.sFlys=b.sflys
	where  1=1 and b.sspbh is null and a.sFlys<>'档次'
	and ( len(a.sYsValue)>0 or  len(a.sYsValue_V)>0)
